////////////////////////////////////////////////////////////////////
// Created source file XPS8_drivers.cpp for API description 
// 
...
/*********************************************************************** 
 * ControllerStatusGet :  Return controller status
 *
 *     - Parameters :
 *            int SocketIndex
 *            int *Status
 ...
 *            int errorCode
 ***********************************************************************/ 
int __stdcall ControllerStatusGet (int SocketIndex, int * Status) 
{ 
	int ret = -1; 
	char ExecuteMethod[SIZE_EXECUTE_METHOD]; 
	char *ReturnedValue = (char *) malloc (sizeof(char) * SIZE_SMALL); 
...
/*********************************************************************** 
 * ControllerStatusStringGet :  Return the error string corresponding to the error code
 *
 *     - Parameters :
 *            int SocketIndex
 *            int StatusCode
 ...
 *            int errorCode
 ***********************************************************************/ 
int __stdcall ControllerStatusStringGet (int SocketIndex, int StatusCode, char * StatusString) 
{ 
	int ret = -1; 
	char ExecuteMethod[SIZE_EXECUTE_METHOD]; 
	char *ReturnedValue = (char *) malloc (sizeof(char) * SIZE_SMALL); 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "ControllerStatusStringGet (%d,char *)", StatusCode);
	...
	{ 
		...
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) strcpy (StatusString, pt);
		ptNext = strchr (StatusString, ',');
		if (ptNext != NULL) *ptNext = '\0';
	} 
	if (NULL != ReturnedValue)
		free (ReturnedValue);
