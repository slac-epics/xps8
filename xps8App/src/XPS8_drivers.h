/*///////////////////////////////////////////////////////////////////
// Created header file XPS8_drivers.h for API headings 
*/ 
...
DLL int __stdcall ControllerStatusGet (int SocketIndex, int * Status); /* Return controller status */
DLL int __stdcall ControllerStatusStringGet (int SocketIndex, int StatusCode, char * StatusString); /* Return the status string corresponding to the status code */
